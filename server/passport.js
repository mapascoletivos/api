        ...
        User.findOne({ email: email }, function (err, user) {
          if (err) return done(err);
            ...
            return done(null, false, {
              message: 'access_token.local.user_not_registered'
            });
              ...
              function (err) {
                if (err) {
                  return done(err, false, {
                    message: 'access_token.local.needs_migration.error'
                  });
                } else {
                  return done(null, false, {
                    message: 'access_token.local.needs_migration.sent'
                  });
                }
              }
            );
            ...
            return done(null, false, {
              message: 'access_token.local.invalid_password'
            });
